...
> `suck`は「ひどい」というスラングではない。  
> `suck`「（大量に）吸う」 <--> `sip`「（一口だけ）吸う」  
> 大量に消費するというスラングに面白いものがある。
> 例えば、ガソリンの大量食いをするアメ車を以下のように表現する。  
>
> - gas guzzlers
> - gas gobbler
...
> `dim`は0/1のスイッチャブルなものではなく、無段階のストロークを指す
...
> `deca-thlon`とは「10の種目」の意味。  
> `decade`も`deca-de`で「10年」の意味。  
> `deca`は国際接頭辞として使われている。
>
> - `decagon`「十角形」
> - `dodecagon`「十二角形」
...
> `on behalf of A` = `representing A`「Aを代表して」
...
Earth is the only planet in the solar system with an **atmosphere**  that can support life.  
地球は太陽系で命を支える大気を持つ唯一の惑星だ。

---

I love to lie on the grass and watch the **passing** clouds in the sky.  
私は草の上に寝転がって空を通り過ぎる雲を見るのが好きだ。

---

The light switch on when a person approaches the door and **dim** after the person passes.  
そのライトはドアに人が近づくと点灯し、通り過ぎると徐々に消灯する。

---

This latest range of washing machines uses 50 percent less water and 60 percent less evergy than **conventional** models.  
この最新型の洗濯機は、従来モデルに比べて50%の水、60%の消費電力である。

---

Our house was freezing in winter until we put **insulation** in the roof.  
私達の家は屋根に断熱材を入れるまで冬に凍りかけていた。

---

The winner of the Olympic **decathlon** is traditionally given the title of "World's Greatest Athlete".  
冬季オリンピック10種競技の優勝者には伝統的に世界で一番のアスリートの称号が与えられる。

---

With good **ventilation**, our office world be more comfortable in summer.  
良好な**換気**により、私たちのオフィスの世界は夏により快適になります。

> Magic: The Gathering「`Steam Vents`/蒸気孔」

---

Don't forget to **charge up** the spare batteries for the torch before we go camping.  
キャンプに行く前に懐中電灯の予備バッテリーを充電するのを忘れるな

---

This computer isn't quite as fast or powerful as that one, but in terms of **affordability**, it's a much better deal.  
このコンピューターは、それほど高速でも強力でもありませんが、手頃な価格という点では、はるかに優れています。

---

One of the **fluorescent tube** above my desk needs replacing.  
机の上の**蛍光灯**の1つを交換する必要があります。
